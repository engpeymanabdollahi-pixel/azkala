...
return [
    ...
    // ═══════════════════════════════════════════════════════
    // 🎁 Referral (پاداش سیستم معرفی دوستان)
    // مبلغ اینجا فقط منبع حقیقتِ «پیش‌فرض/قابل‌ویرایش از پنل ادمین» است؛
    // ReferralRewardService این کلید را با Setting::get(...) می‌خواند و
    // به config/azkala/referral.php (که خودش از env می‌آید) به‌عنوان
    // fallback رجوع می‌کند — دقیقاً همان لایه‌بندی commission_default_rate.
    // ═══════════════════════════════════════════════════════
    [
        ...
        'description' => 'مبلغ اعتبار ثابتی که هنگام اولین سفارشِ موفقِ کاربر معرفی‌شده، به معرف تعلق می‌گیرد. باید عددی و بزرگ‌تر یا مساوی صفر باشد.',
    ],
];