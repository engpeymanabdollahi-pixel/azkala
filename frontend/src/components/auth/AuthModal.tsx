...
// =====================================================================
const NEU = {
  // ✅ درخواست کاربر: سایه‌ی دور خودِ پنل مودال باید حذف یا خیلی کم شود.
  // سایه‌ی neumorphic دوطرفه‌ی قبلی (۱۲px blur + هایلایت سفید مقابل)
  // چون کل صفحه پشت آن با overlay تیره پوشیده می‌شود، در عمل فقط یک
  // outline پررنگ دور مودال دیده می‌شد. جایگزین شد با یک سایه‌ی استاندارد
  // و بسیار ملایم (تک‌جهته، بدون هایلایت مقابل) فقط برای جدا کردن لبه‌ی
  // مودال از پس‌زمینه — سایه‌های داخلی input/button (inputLight/btnLight
  // پایین‌تر) دست‌نخورده ماندند، چون بخشی جدا از ظاهر neumorphic خودِ
  // فرم‌اند و در درخواست کاربر «دور مودال» صریحاً از آن‌ها متمایز شد.
  cardLight: 'shadow-[0_4px_16px_rgba(0,0,0,0.08)]',
  cardDark: 'dark:shadow-[0_4px_16px_rgba(0,0,0,0.3)]',
