...
>(({ className, ...props }, ref) => (
  <DropdownMenuPrimitive.SubContent
    ref={ref}
    className={cn(
      'z-[200] min-w-[8rem] overflow-hidden rounded-xl border border-gray-200 dark:border-slate-700',
      'bg-white dark:bg-slate-800 p-1 text-gray-900 dark:text-gray-100 shadow-lg',
...
>(({ className, inset, ...props }, ref) => (
  <DropdownMenuPrimitive.Item
    ...
    className={cn(
      ...
      'focus:bg-gray-100 dark:focus:bg-slate-700 focus:text-gray-900 dark:focus:text-white',
...
>(({ className, children, checked, ...props }, ref) => (
  <DropdownMenuPrimitive.CheckboxItem
    ref={ref}
    className={cn(
      'relative flex cursor-default select-none items-center rounded-lg py-2 pr-8 pl-3 text-sm outline-none transition-colors',
      'focus:bg-gray-100 dark:focus:bg-slate-700',
      'data-[disabled]:pointer-events-none data-[disabled]:opacity-50',
      className
    )}
...
const DropdownMenuShortcut = ({ className, ...props }: React.HTMLAttributes<HTMLSpanElement>) => {
  return (
    <span
      className={cn('mr-auto text-xs tracking-widest text-gray-500 dark:text-gray-400', className)}
      {...props}
    />
  );
};
