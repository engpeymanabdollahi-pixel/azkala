...
export function HelpPage() {
  ...
  const faqs = [
    { q: 'چگونه می‌توانم مدل گوشی خود را انتخاب کنم؟', a: 'در بالای صفحه روی دکمه «انتخاب مدل گوشی» کلیک کنید و برند و مدل دستگاه خود را انتخاب کنید. پس از انتخاب، فقط محصولات سازگار نمایش داده می‌شوند.' },
    { q: 'چگونه از سازگاری محصول مطمئن شوم؟', a: 'پس از انتخاب مدل گوشی، محصولاتی که با دستگاه شما سازگار هستند دارای نشان «سازگار با گوشی شما» هستند. همچنین در صفحه جزئیات محصول، وضعیت سازگاری نمایش داده می‌شود.' },
