                  ...
                  <div className="hidden md:flex w-1/3 relative items-center justify-center min-h-[450px]">
                    {compatibleProducts.length > 0 && compatibleProducts[0]?.main_image ? (
                      <div className="relative z-30 animate-float" style={{ animationDuration: '6s' }}>
                        ...
                        <div className="relative bg-white/10 backdrop-blur-md p-3 rounded-3xl border-2 border-white/20 shadow-2xl hover:scale-105 transition-transform duration-500">
                          <SafeImage
                            src={compatibleProducts[0].main_image}
                            alt={compatibleProducts[0].name}
                      ...
                      <div className="relative z-30 animate-float" style={{ animationDuration: '6s' }}>
                        <div className="w-64 h-64 bg-gradient-to-br from-white/10 to-white/5 rounded-full backdrop-blur-xl border border-white/10 flex items-center justify-center shadow-2xl">
                    ...
                    {compatibleProducts.length > 1 && compatibleProducts[1]?.main_image && (
                      ...
                      >
                        <div className="bg-white/10 backdrop-blur-md p-2 rounded-2xl border border-white/20 shadow-xl rotate-6 hover:rotate-0 hover:scale-110 transition-all duration-500">
                          <SafeImage
                            src={compatibleProducts[1].main_image}
                            alt={compatibleProducts[1].name}
                    ...
                    {compatibleProducts.length > 2 && compatibleProducts[2]?.main_image && (
                      ...
                      >
                        <div className="bg-white/10 backdrop-blur-md p-2 rounded-2xl border border-white/20 shadow-xl -rotate-12 hover:rotate-0 hover:scale-110 transition-all duration-500">
                          <SafeImage
                            src={compatibleProducts[2].main_image}
                            alt={compatibleProducts[2].name}
                    ...
                    {compatibleProducts.length > 3 && compatibleProducts[3]?.main_image && (
                      ...
                      >
                        <div className="bg-white/10 backdrop-blur-md p-2 rounded-2xl border border-white/20 shadow-xl rotate-12 hover:rotate-0 hover:scale-110 transition-all duration-500">
                          <SafeImage
                            src={compatibleProducts[3].main_image}
                            alt={compatibleProducts[3].name}
                    ...
                    {compatibleProducts.length > 4 && compatibleProducts[4]?.main_image && (
                      ...
                      >
                        <div className="bg-white/10 backdrop-blur-md p-2 rounded-2xl border border-white/20 shadow-xl -rotate-6 hover:rotate-0 hover:scale-110 transition-all duration-500">
                          <SafeImage
                            src={compatibleProducts[4].main_image}
                            alt={compatibleProducts[4].name}
