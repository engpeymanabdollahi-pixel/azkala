...
import {
  Sparkles, TrendingUp, Loader2, Settings,
  ChevronLeft, ChevronRight, ShoppingBag, Users,
  DollarSign, MousePointer, Award,
} from 'lucide-react';
...
type TabType = 'overview' | 'list' | 'top' | 'settings';
    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between flex-wrap gap-3">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="text-2xl font-black text-gray-900 dark:text-gray-100">مدیریت پیشنهادات محصول</h1>
            <p className="text-sm text-gray-500 dark:text-gray-400 mt-1">تحلیل و بهینه‌سازی سیستم پیشنهاد هوشمند</p>
          </div>
        </div>
      </div>
      ...
      <div className="flex gap-2 border-b border-gray-200 dark:border-gray-700">
        {[
          { id: 'overview' as const, label: 'نمای کلی', icon: TrendingUp },
          { id: 'list' as const, label: 'لیست پیشنهادات', icon: ShoppingBag },
          { id: 'top' as const, label: 'برترین‌ها', icon: Award },
        ...
        <>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            <div className="bg-white dark:bg-gray-800 rounded-xl p-4 border border-gray-100 dark:border-gray-700 shadow-sm">
              ...
              <p className="text-xs text-gray-500 dark:text-gray-400 mt-1">کل پیشنهادات</p>
            </div>
            ...
            <div className="bg-white dark:bg-gray-800 rounded-xl p-4 border border-gray-100 dark:border-gray-700 shadow-sm">
              ...
              <p className="text-2xl font-black text-blue-600 dark:text-blue-400">{stats.click_rate}%</p>
              <p className="text-xs text-gray-500 dark:text-gray-400 mt-1">نرخ کلیک</p>
            </div>
            ...
            <div className="bg-white dark:bg-gray-800 rounded-xl p-4 border border-gray-100 dark:border-gray-700 shadow-sm">
              ...
              <p className="text-2xl font-black text-green-600 dark:text-green-400">{stats.conversion_rate}%</p>
              <p className="text-xs text-gray-500 dark:text-gray-400 mt-1">نرخ تبدیل</p>
            </div>
            ...
            <div className="bg-white dark:bg-gray-800 rounded-xl p-4 border border-gray-100 dark:border-gray-700 shadow-sm">
              ...
              <p className="text-2xl font-black text-purple-600 dark:text-purple-400">{formatPrice(stats.revenue)}</p>
              <p className="text-xs text-gray-500 dark:text-gray-400 mt-1">درآمد از پیشنهادات</p>
            </div>
          </div>
              ...
              {stats.trend.map((day, i) => {
                ...
                return (
                  <div key={i} className="flex items-center gap-3">
                    ...
                    <div className="flex-1 flex h-6 rounded-lg overflow-hidden bg-gray-100 dark:bg-gray-700">
                      {day.total > 0 && (
                        <>
                          <div
                          ...
                          <div
                            ...
                            className="bg-gray-300 dark:bg-gray-500 transition-all"
                            title="بدون کلیک"
                          />
                        </>
                      )}
                    </div>
                    <span className="w-16 text-xs text-gray-600 dark:text-gray-300 text-right">{day.total.toLocaleString('fa-IR')}</span>
                  </div>
                );
              })}
            </div>
            <div className="flex items-center justify-center gap-6 mt-4 pt-3 border-t border-gray-100 dark:border-gray-700">
              <div className="flex items-center gap-2"><div className="w-3 h-3 rounded-full bg-green-500" /><span className="text-xs text-gray-600 dark:text-gray-300">خرید</span></div>
              <div className="flex items-center gap-2"><div className="w-3 h-3 rounded-full bg-blue-500" /><span className="text-xs text-gray-600 dark:text-gray-300">کلیک</span></div>
              <div className="flex items-center gap-2"><div className="w-3 h-3 rounded-full bg-gray-300 dark:bg-gray-500" /><span className="text-xs text-gray-600 dark:text-gray-300">بدون کلیک</span></div>
            </div>
          </div>
            ...
            <div className="bg-white dark:bg-gray-800 rounded-xl border border-gray-100 dark:border-gray-700 shadow-sm p-4">
              ...
              <div className="space-y-2">
                {topProducts.length === 0 ? (
                  <p className="text-xs text-gray-500 dark:text-gray-400 text-center py-4">داده‌ای برای نمایش وجود ندارد</p>
                ) : (
                  topProducts.slice(0, 5).map((item, i) => (
                    <div key={item.product_id} className="flex items-center gap-3 p-2 bg-gray-50 dark:bg-gray-700/50 rounded-lg">
                      <span className="w-6 h-6 bg-yellow-100 dark:bg-yellow-900/40 text-yellow-700 dark:text-yellow-400 rounded-full flex items-center justify-center text-xs font-bold">
                        {i + 1}
                      </span>
                      <div className="flex-1 min-w-0">
                        <p className="text-xs font-bold text-gray-900 dark:text-gray-100 truncate">{item.product?.name}</p>
              ...
              <div className="space-y-2">
                {topSellers.length === 0 ? (
                  ...
                  topSellers.slice(0, 5).map((item, i) => (
                    <div key={item.seller?.id} className="flex items-center gap-3 p-2 bg-gray-50 dark:bg-gray-700/50 rounded-lg">
                      <span className="w-6 h-6 bg-primary-100 dark:bg-primary-900/40 text-primary-700 dark:text-primary-400 rounded-full flex items-center justify-center text-xs font-bold">
                        {i + 1}
                      </span>
                      <div className="flex-1 min-w-0">
                        <p className="text-xs font-bold text-gray-900 dark:text-gray-100 truncate">{item.seller?.name}</p>
                        <p className="text-[10px] text-gray-500 dark:text-gray-400">
          ...
          <div className="bg-white dark:bg-gray-800 rounded-xl p-4 border border-gray-100 dark:border-gray-700 shadow-sm">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
              <select
                ...
                className="px-3 py-2 border border-gray-200 dark:border-gray-600 rounded-lg text-sm bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100 focus:outline-none focus:border-primary-500"
              >
          ...
          <div className="bg-white dark:bg-gray-800 rounded-xl border border-gray-100 dark:border-gray-700 shadow-sm overflow-hidden">
            {isLoading ? (
              ...
              <div className="divide-y divide-gray-100 dark:divide-gray-700">
                {suggestions.map((sug) => (
                  <div key={sug.id} className="p-4 hover:bg-gray-50 dark:hover:bg-gray-700/50 transition-colors">
                    <div className="flex items-start gap-3">
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        <p className="text-sm font-bold text-gray-900 dark:text-gray-100 mb-1">{sug.product?.name}</p>
                ...
                topProducts.map((item, i) => (
                  <div key={item.product_id} className="p-3 bg-gray-50 dark:bg-gray-700/50 rounded-lg">
                    <div className="flex items-start gap-3">
                      ...
                      <div className="flex-1 min-w-0">
                        <p className="text-sm font-bold text-gray-900 dark:text-gray-100 mb-1">{item.product?.name}</p>
                        <div className="grid grid-cols-3 gap-2 text-xs">
                          <div>
                            <p className="text-gray-500 dark:text-gray-400">پیشنهاد</p>
                            <p className="font-bold text-gray-900 dark:text-gray-100">{item.total_suggestions}</p>
                          </div>
                          <div>
                            <p className="text-gray-500 dark:text-gray-400">کلیک</p>
                            <p className="font-bold text-blue-600 dark:text-blue-400">{item.total_clicked}</p>
                          </div>
                          <div>
                            <p className="text-gray-500 dark:text-gray-400">خرید</p>
                            <p className="font-bold text-green-600 dark:text-green-400">{item.total_purchased}</p>
                          </div>
                        </div>
            ...
            <div className="space-y-3">
              {topSellers.length === 0 ? (
                ...
                topSellers.map((item, i) => (
                  <div key={item.seller?.id} className="p-3 bg-gray-50 dark:bg-gray-700/50 rounded-lg">
                    <div className="flex items-start gap-3">
                      <span className={cn(
                        'w-8 h-8 rounded-lg flex items-center justify-center text-xs font-black text-white flex-shrink-0',
                        i === 0 && 'bg-gradient-to-br from-yellow-400 to-amber-500',
                      ...
                      <div className="flex-1 min-w-0">
                        <p className="text-sm font-bold text-gray-900 dark:text-gray-100 mb-1">{item.seller?.name}</p>
                        {item.seller?.shop_name && (
                          <p className="text-xs text-gray-500 dark:text-gray-400">{item.seller.shop_name}</p>
                        )}
        ...
        <div className="bg-white dark:bg-gray-800 rounded-xl border border-gray-100 dark:border-gray-700 shadow-sm p-6">
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-3 pt-4 border-t border-gray-100 dark:border-gray-700">
              <h4 className="text-sm font-bold text-gray-700 dark:text-gray-300">اولویت‌بندی:</h4>
              <label className="flex items-center gap-2 cursor-pointer">
                ...
                />
                <span className="text-sm text-gray-700 dark:text-gray-300">اولویت با محصولات هم‌دسته‌بندی</span>
              </label>
              <label className="flex items-center gap-2 cursor-pointer">
                <input
                  type="checkbox"
                  ...
                  className="w-4 h-4 rounded"
                />
                <span className="text-sm text-gray-700 dark:text-gray-300">اولویت با محصولات پرفروش</span>
              </label>
              <label className="flex items-center gap-2 cursor-pointer">
                <input
                  type="checkbox"
                  ...
                  className="w-4 h-4 rounded"
                />
                <span className="text-sm text-gray-700 dark:text-gray-300">اولویت با محصولات جدید</span>
              </label>
            </div>

            <div className="space-y-3 pt-4 border-t border-gray-100 dark:border-gray-700">
              <h4 className="text-sm font-bold text-gray-700 dark:text-gray-300">فعال‌سازی:</h4>
              <label className="flex items-center gap-2 cursor-pointer">
                <input
                  type="checkbox"
                  ...
                  className="w-4 h-4 rounded"
                />
                <span className="text-sm text-gray-700 dark:text-gray-300">پیشنهاد خودکار فعال باشد</span>
              </label>
              <label className="flex items-center gap-2 cursor-pointer">
                <input
                  type="checkbox"
                  ...
                  className="w-4 h-4 rounded"
                />
                <span className="text-sm text-gray-700 dark:text-gray-300">پیشنهاد دستی توسط فروشنده فعال باشد</span>
              </label>
            </div>
