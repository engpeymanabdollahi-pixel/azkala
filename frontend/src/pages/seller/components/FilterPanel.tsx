    ...
    <div className={cn(
      ...
      <div className="p-4 bg-gradient-to-r from-primary-50 to-accent-50 dark:from-primary-900/20 dark:to-accent-900/20 border-b border-gray-100 dark:border-gray-700 flex items-center justify-between">
        <div className="flex items-center gap-2">
          ...
          <h3 className="font-black text-gray-900 dark:text-gray-100">فیلترهای پیشرفته</h3>
      ...
      <div className="p-4 space-y-6 max-h-[calc(100vh-300px)] overflow-y-auto">
        ...
        <div className="space-y-2">
          <label className="text-sm font-bold text-gray-700 dark:text-gray-300 block">جستجو</label>
        ...
        {categories.length > 0 && (
          <div className="space-y-2">
            <label className="text-sm font-bold text-gray-700 dark:text-gray-300 block">دسته‌بندی‌ها</label>
        ...
        {brands.length > 0 && (
          <div className="space-y-2">
            <label className="text-sm font-bold text-gray-700 dark:text-gray-300 block">برندها</label>
        ...
        <div className="space-y-3">
          <label className="text-sm font-bold text-gray-700 dark:text-gray-300 block">محدوده قیمت</label>
          <div className="grid grid-cols-2 gap-3">
            <div>
              <label htmlFor="template-min-price" className="text-xs text-gray-500 dark:text-gray-400 block mb-1">حداقل</label>
              <input
            ...
            <div>
              <label htmlFor="template-max-price" className="text-xs text-gray-500 dark:text-gray-400 block mb-1">حداکثر</label>
              <input
